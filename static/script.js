...
// If adding the image back again
...
//             const data = await processResponse.json();
//             console.log("This is the processed response data: ", data);
//             console.log(data['processing callback']);
//             const placeholder2 = document.querySelector('.imageplaceholder2');

//             let bwImg = placeholder.querySelector('#bwImage');
//             if (!bwImg) {
//                 bwImg = document.createElement('img');
//                 bwImg.id = 'bwImage';
//                 placeholder2.appendChild(bwImg);
//             }
//             bwImg.src = data.bw_image_url;
//             bwImg.alt = 'Processed Black and White Image';
//             placeholder2.style.backgroundColor = 'black';
//         } else {
//             console.error('Failed to process the image');
//         }
//     } else {
